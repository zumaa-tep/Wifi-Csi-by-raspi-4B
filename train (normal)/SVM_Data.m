...
function [Data_Test_SVM,Labels_Test_SVM ] = SVM_Data(Data_Train_SVM, Labels_Train_SVM, filepath1_Test_Empty, numpackets, filepath2_Test_SIT, filepath3_Test_STAND, filepath4_Test_WALK,filepath5_Test_FALL)
%% TESTING
% tic
...
Number_FALL_Files = length(filepath5_Test_FALL);% number of Experiment Files for train
Data_FALL = [];

for i=1:Number_FALL_Files  %%%% สำหรับ class ที่ 5
...
Data_Test_SVM = [Data_Empty; Data_Sit;Data_Stand;Data_Walk;Data_FALL];
